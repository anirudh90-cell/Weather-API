...
function SubForm(event){
    ...
    $.ajax({
        ...
        success: function(){
          ...
          alert("Suggestion has been sent to the WeatherBeats Teams :)")
        },
        error: function(){
...
document.querySelector("#privacy").addEventListener("click", function(e){
    e.preventDefault();
    alert("WeatherWave has no privacy policy");
});
document.querySelector("#service").addEventListener("click", function(e){
    e.preventDefault();
alert("WeatherWave has not yet announced any terms of service.");
});

/*registration/login page javascript*/
